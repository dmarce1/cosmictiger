...
C	dimensions for integrator
	...
	write(*,*)' (or 1.125 plus high z fit),'
	write(*,*)' b_He fudge factor = 0.86,'
	write(*,*)' and a fit to tabulated HeII '
	write(*,*)'singlet recombination rates'
	write(*,*)
...
c	will output every 10 in z, but this is easily changed also
	...
	write(*,*)'Enter Omega_B, Omega_DM, '
	write(*,*)' Omega_vac (e.g. 0.04 0.20 0.76)'
...
C	Modification for HeI recombination (Heswitch):
	...
	write(*,*)'2) also including effect of '
	write(*,*)' contiuum opacity of H on HeI'
...
c	smoother criterion here from Antony Lewis & Chad Fendt
	  if(((Heflag.eq.2).or.(Heflag.ge.5)).and.(x_H.lt.0.999999d0))then
