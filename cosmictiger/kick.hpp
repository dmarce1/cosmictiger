...
struct cuda_kick_shmem {
	...
	array<float, BUCKET_SIZE> sink_zeta1;
	array<float, BUCKET_SIZE> sink_zeta2;
	...
	struct {
		...
		array<float, KICK_PP_MAX> zeta1;
		array<float, KICK_PP_MAX> zeta2;
	}src;
...
#ifdef USE_CUDA
vector<kick_return> cuda_execute_kicks(kick_params params, fixed32*, fixed32*, fixed32*,char*, float*, float*, float*, tree_node*, vector<kick_workitem> workitems, cudaStream_t stream,
