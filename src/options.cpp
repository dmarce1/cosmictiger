...
bool process_options(int argc, char *argv[]) {
	...
	("hsoft", po::value<double>(&(opts.hsoft))->default_value(1.0 / 30.0), "dark matter softening in units of interparticle spacing") //
	("kernel", po::value<double>(&(opts.kernel))->default_value(4.745077), "kernel index") //
	...
	("code_to_g", po::value<double>(&(opts.code_to_g))->default_value(8*1.5e9), "mass resolution") //
