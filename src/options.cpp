...
bool process_options(int argc, char *argv[]) {
	...
	("htime", po::value<bool>(&(opts.htime))->default_value(false), "use hierachical time integration") //
	...
	("nsteps", po::value<int>(&(opts.nsteps))->default_value(1024), "Number of super-timesteps") //
